...
function agregarEmpleado(){
    ...
    mostrarEmpleados(); //para enviar la lista al html
    //16.
...
function editarEmpleado(){
    ...
    listaEmpleados.map(empleado =>{//recorre el array y solo edita el que coincide con el id
        if(empleado.id === objEmpleado.id){ //toma el id del objeto global, el id se establecio previamente en cargarEmpleado
